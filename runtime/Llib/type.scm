...
(module __type
   ...
   (type
    ...
    (subtype elong "BGL_LONG_T" (cobj))
    (subtype uelong "BGL_ULONG_T" (cobj))
...
;*     (coerce bint uint64 () ($bint->uint64))                         */
   ...
   (extern
    ...
    (macro $bint->long::long (::bint) "(BGL_LONG_T)CINT")
    (macro $bint->ulong::ulong (::bint) "(BGL_ULONG_T)CINT")
    ...
    (macro $ubyte->long::long (::ubyte) "(BGL_LONG_T)")
    (macro $ubyte->ulong::ulong (::ubyte) "(BGL_ULONG_T)")
    ...
    (macro $byte->long::long (::byte) "(BGL_LONG_T)")
    (macro $byte->ulong::ulong (::byte) "(BGL_ULONG_T)")
    ...
    (macro $short->long::long (::short) "(BGL_LONG_T)")
    (macro $short->ulong::ulong (::short) "(BGL_ULONG_T)")
    ...
    (macro $ushort->long::long (::ushort) "(BGL_LONG_T)")
    (macro $ushort->ulong::ulong (::ushort) "(BGL_ULONG_T)'")
    ...
    (macro $int->long::long (::int) "(BGL_LONG_T)")
    (macro $int->ulong::ulong (::int) "(BGL_ULONG_T)")
    ...
    (macro $uint->long::long (::uint) "(BGL_LONG_T)")
    (macro $uint->ulong::ulong (::uint) "(BGL_ULONG_T)")
    ...
    (macro $long->ulong::ulong (::long) "(BGL_ULONG_T)")
    ...
    (macro $ulong->long::long (::ulong) "(BGL_LONG_T)")
    ...
    (macro $uelong->elong::elong (::uelong) "(BGL_LONG_T)")
    (macro $elong->uelong::uelong (::elong) "(BGL_ULONG_T)")
    ...
    (macro $long->elong::elong (::long) "(BGL_LONG_T)")
    (macro $long->uelong::uelong (::long) "(BGL_ULONG_T)")
    (macro $elong->long::elong (::long) "(BGL_LONG_T)")
    (macro $uelong->long::elong (::long) "(BGL_LONG_T)")
    ...
    (macro $uint32->ulong::ulong (::uint32) "(BGL_ULONG_T)")
